...
std::shared_ptr<_private_::Renderer> single_threaded(unsigned horizontal_resolution, unsigned vertical_resolution, raytracer::samplers::Sampler sampler, RayTracer ray_tracer)
{
