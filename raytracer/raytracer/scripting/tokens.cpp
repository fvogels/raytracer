...
void scripting::LeftParenthesisToken::accept(TokenVisitor& visitor)
{
	visitor.visit(*this);
}

void scripting::RightParenthesisToken::accept(TokenVisitor& visitor)
{
	visitor.visit(*this);
}

void scripting::SymbolToken::accept(TokenVisitor& visitor)
{
	visitor.visit(*this);
}

void scripting::StringToken::accept(TokenVisitor& visitor)
{
	visitor.visit(*this);
}

void scripting::NumberToken::accept(TokenVisitor& visitor)
{
	visitor.visit(*this);
}
