...
Color raytracer::raytracers::_private_::RayTracerV7::compute_translucency(const Scene& scene, const MaterialProperties& material_properties, const Hit& hit, const math::Ray& eye_ray, double weight) const
{
    if (material_properties.translucency > 0)
    {
