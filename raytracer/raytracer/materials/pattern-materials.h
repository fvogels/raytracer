...
namespace raytracer
{
    namespace materials
    {
        Material pattern2d(math::Function<bool(const math::Point2D&)>, Material, Material); // TODO Remove
        Material pattern3d(math::Function<bool(const math::Point3D&)>, Material, Material); // TODO Remove
