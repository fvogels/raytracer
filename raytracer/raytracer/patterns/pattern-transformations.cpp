...
Pattern2D patterns::transform(const math::Transformation2D& transformation, Pattern2D pattern)
{
...
Pattern3D patterns::transform(const math::Transformation3D& transformation, Pattern3D pattern)
{
...
Pattern2D patterns::translate(math::Vector2D displacement, Pattern2D pattern)
{
    return transform(math::transformations::translation(displacement), pattern);
}

Pattern2D patterns::rotate(math::Angle angle, Pattern2D pattern)
{
    return transform(math::transformations::rotate(angle), pattern);
}

Pattern2D patterns::scale(double sx, double sy, Pattern2D pattern)
{
    return transform(math::transformations::scale(sx, sy), pattern);
}

Pattern3D patterns::translate(math::Vector3D displacement, Pattern3D pattern)
{
    return transform(math::transformations::translation(displacement), pattern);
}

Pattern3D patterns::rotate_x(math::Angle angle, Pattern3D pattern)
{
    return transform(math::transformations::rotate_x(angle), pattern);
}

Pattern3D patterns::rotate_y(math::Angle angle, Pattern3D pattern)
{
    return transform(math::transformations::rotate_y(angle), pattern);
}

Pattern3D patterns::rotate_z(math::Angle angle, Pattern3D pattern)
{
    return transform(math::transformations::rotate_z(angle), pattern);
}

Pattern3D patterns::scale(double sx, double sy, double sz, Pattern3D pattern)
{
