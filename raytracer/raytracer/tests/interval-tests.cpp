...
{
    auto i = Interval<Angle>(60_degrees, 180_degrees);
...
{
    auto i = Interval<Point3D>(Point3D(1,2,3), Point3D(5,8,9));
...
{
    auto i = Interval<TimeStamp>(TimeStamp::from_epoch(1_s), TimeStamp::from_epoch(5_s));
